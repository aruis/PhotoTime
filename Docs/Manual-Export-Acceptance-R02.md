...
- [x] 启动后点击“选择图片”导入素材
- [x] 在“更多”中点击“选择导出路径”
- [x] 选择路径：`/Users/aruis/Downloads/ReelFlow-Output.mp4`
- [x] 点击“导出 MP4”
...
结果记录：  
击“打开输出目录”可定位到导出文件，失败了，提示：应用程序“ReelFlow”没有权限打开“下载”。 
...
|---|------------------------------------------------|---|---|---|
| 1 | 打开目标按钮报错：应用程序“ReelFlow”没有权限打开“下载”。            |  |  |  |
| 2 | 左侧图片浏览区，不应该能收起来                                |  |  |  |
...
- [x] `./scripts/test-ui-smoke.sh` 通过（6/6）
- [x] `xcodebuild ... -only-testing:ReelFlowTests/ExportViewModelLogHandlingTests` 通过
